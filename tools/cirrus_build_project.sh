...
# VM has 12 GB of free RAM.  Assuming each of the 4 logical cores takes 1 GB during build, that leaves us with 8 GB of unutilized RAM.  Alas, I'm not sure that's enough, so this isn't enabled right now.
#echo "Mounting tmpfs..."
